# ng-hub-ui-nav — Referencia de Variables CSS

Este documento lista las propiedades CSS custom que expone `ng-hub-ui-nav`.

## Uso

Importa los estilos de la librería y sobrescribe los tokens a nivel de componente, página o tema.
